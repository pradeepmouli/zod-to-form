...
title: Contributing
sidebar_position: 5
description: Development workflow, branch naming, testing, and release process for contributing to zod-to-form.
---
...
git clone https://github.com/pradeepmouli/zod-to-form.git
cd zod-to-form
...
# See the Workspace Layout guide for a template
...
See [SECURITY.md](https://github.com/pradeepmouli/zod-to-form/blob/master/SECURITY.md) and [CONTRIBUTING.md](https://github.com/pradeepmouli/zod-to-form/blob/master/CONTRIBUTING.md) for details on:
- Creating releases
- Versioning strategy
- Publishing packages
- Security policies
