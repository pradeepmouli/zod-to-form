...
title: Testing
sidebar_position: 2
description: Testing strategy for zod-to-form — Vitest for unit and integration tests, Playwright for end-to-end.
---
...
Configure in [vitest.config.ts](https://github.com/pradeepmouli/zod-to-form/blob/master/vitest.config.ts).
...
Tests run against Chromium, Firefox, and WebKit by default. Configure in [playwright.config.ts](https://github.com/pradeepmouli/zod-to-form/blob/master/playwright.config.ts).
...
See [.github/workflows/ci.yml](https://github.com/pradeepmouli/zod-to-form/blob/master/.github/workflows/ci.yml) for details.
