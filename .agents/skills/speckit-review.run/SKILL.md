...
metadata:
  ...
  source: templates/commands/review.run.md
---
...
**code**:
- Checks project-specific guidelines (`.specify/memory/constitution.md`, `AGENTS.md`, `.github/copilot-instructions.md`, or equivalent) compliance
