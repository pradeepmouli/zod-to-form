...
metadata:
  ...
  source: templates/commands/review.simplify.md
---

# Speckit Review.Simplify Skill
...
2. **Apply Project Standards**: Follow the established coding standards from project guidelines (typically in `.specify/memory/constitution.md`, `AGENTS.md`, `.github/copilot-instructions.md` or equivalent).
