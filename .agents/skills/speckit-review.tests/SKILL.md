...
metadata:
  ...
  source: templates/commands/review.tests.md
---

# Speckit Review.Tests Skill
...
- Consider the project's testing standards from project guidelines (typically in `.specify/memory/constitution.md`, `AGENTS.md`, `.github/copilot-instructions.md` or equivalent) if available
